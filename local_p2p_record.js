...
function gotStream(stream) {
  ...
  //audio.srcObject = localStream;   //this can be uncommented if we want to stream local audio also, but it will cause echo due to remote audio
...
function call() {
  ...
  // var config = { "iceServers": [{ "urls": ["stun:stun.1.google.com:19302"] }] };        // conn = new RTCPeerConnection(config);
  const servers = null;
